...
def main():
     ...
     start = time.clock()
     d_1 = testmodels(X_tr, y_tr, X_te, y_te, [[50,1,2],[50,50,2],[50,50,50,2],[50,50,50,50,2]], 'linear', 'softmax', [0.0], 30, 1000, 0.001, [0.0], [0.0], False, False, 0)
     end = time.clock()
     print(end - start)
     
     start = time.clock()
     d_2 = testmodels(X_tr, y_tr, X_te, y_te, [[50,50,2],[50,500,2],[50,500,300,2],[50,800,500,300,2],[50,800,800,500,300,2]], 'linear', 'softmax', [0.0], 30, 1000, 0.001, [0.0], [0.0], False, False, 0)
     end = time.clock()
     print(end - start)
     
     
     start = time.clock()      
     e_1 = testmodels(X_tr, y_tr, X_te, y_te, [[50,500,2],[50,500,300,2],[50,800,500,300,2],[50,800,800,500,300,2]], 'sigmoid', 'softmax', [0.0], 30, 1000, 0.001, [0.0], [0.0], False, False, 0)
     end = time.clock()
     print(end - start)
     

     start = time.clock()      
     f = testmodels(X_tr, y_tr, X_te, y_te, [[50,500,2],[50,500,300,2],[50,800,500,300,2],[50,800,800,500,300,2]], 'relu', 'softmax', [0.0], 30, 1000, 5e-4, [0.0], [0.0], False, False, 0)
     end = time.clock()
     print(end - start)

     
     start = time.clock()
     g = testmodels(X_tr, y_tr, X_te, y_te, [[50,800,500,300,2]], 'relu', 'softmax', [1e-7,5e-7,1e-6,5e-6,1e-5], 30, 1000, 5e-4, [0.0], [0.0], False, False, 0)
     end = time.clock()
     print(end - start)
     
     start = time.clock()
     h = testmodels(X_tr, y_tr, X_te, y_te, [[50,800,500,300,2]], 'relu', 'softmax', [1e-7, 5e-7, 1e-6, 5e-6, 1e-5], 30, 1000, 5e-4, [0.0], [0.0], False, True, 0)
     end = time.clock()
     print(end - start)
     
     start = time.clock()
     i = testmodels(X_tr, y_tr, X_te, y_te, [[50,800,500,300,2]], 'relu', 'softmax', [5e-7], 100, 1000, 1e-5, [1e-5, 5e-5, 1e-4, 3e-4, 7e-4, 1e-3], [0.0], False, False, 0)
     end = time.clock()
     print(end - start)

     start = time.clock()
     j = testmodels(X_tr, y_tr, X_te, y_te, [[50,800,500,300,2]], 'relu', 'softmax', [0.0], 50, 1000, 1e-5, [1e-5], [0.99,0.98,0.95,0.9,0.85], True, False, 0)
     end = time.clock()
     print(end - start)
#    
     start = time.clock()
     k = testmodels(X_tr, y_tr, X_te, y_te, [[50,800,500,300,2]], 'relu', 'softmax', [5e-6], 100, 1000, 1e-5, [1e-5], [0.99], True, True, 0)
     end = time.clock()
     print(end - start)
     
     start = time.clock()
     l = testmodels(X_tr, y_tr, X_te, y_te, [[50,50,2],[50,500,2],[50,500,300,2],[50,800,500,300,2],[50,800,800,500,300,2]], 'relu', 'softmax', [1e-7,5e-7,1e-6,5e-6,1e-5], 100, 1000, 1e-5, [1e-5,5e-5,1e-4], [0.99], True, True, 0)
     end = time.clock()
     print(end - start)
